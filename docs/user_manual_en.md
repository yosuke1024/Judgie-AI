...
- You can configure the languages or tones (e.g. Japanese, English, French, Slang, Professional) that the AI judges will use to write the evaluation feedback, action items, objections, and admin chat responses. Enter up to 5 custom names separated by commas.
  - *Example: "English, Japanese, Spanish, Gal-go"*
- > [!WARNING]
