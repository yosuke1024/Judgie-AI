...
#### Step 5: Configure AI Response Languages
- Go to the **"🤖 AI Response Settings"** tab.
- You can configure the languages (e.g. Spanish, French, Korean) that the AI judges will use to write the evaluation feedback, action items, objections, and admin chat responses. You can easily add and remove languages using the list UI, up to a maximum of 5.
  - *Example: "English, Spanish, French, Korean"*
- > [!WARNING]
  > **Performance Warning**: Specifying multiple languages increases the amount of text generated by the AI. This will prolong the response time (latency). It is highly recommended to configure only 1 or 2 essential languages for optimal performance.
...
- **Feedback Tabs:**
  ...
  - *Note: If the organizer has configured multiple response languages, tabs for each language will appear within each feedback section (evaluation dashboard, objections response, etc.), allowing you to easily switch between them.*
